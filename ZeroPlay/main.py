...
class Game:
    ...
    def handle_game_over_and_restart(self):
        """Resets the character for a new run, saves, and returns to the start menu."""
        # Reset the character's state for the new run
        self.character.reset_for_new_run()
        
        # Save the reset character state
