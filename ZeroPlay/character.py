...
class Character:
    ...
    def reset_for_new_run(self):
        """Resets the character for a new run after death, increasing base stats."""
        ...
        # Reset inventory and equipment, but keep a small amount of copper
        self.inventory = []
        self.equipment = {'Kopf': None, 'Brust': None, 'Waffe': None}
        self.copper = 100 # Start with a small amount of copper

        # Reset boss progression
        self.boss_tier = 0
        
        # Recalculate derived stats and heal to full
